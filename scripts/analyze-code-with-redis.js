// This is the updated /api/analyze-code endpoint with Redis caching
// Replace the existing endpoint in server.js with this code

/**
 * @route POST /api/analyze-code
 * @desc Analyze code with Google Gemini AI (with Redis caching)
 */
